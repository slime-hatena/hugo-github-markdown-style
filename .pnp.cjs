...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      {
        "name": "hugo-github-markdown-style",
        "reference": "workspace:."
      }
    ],
    ...
    "fallbackExclusionList": [
      ["hugo-github-markdown-style", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["github-markdown-css", [
        ["npm:5.1.0", {
          "packageLocation": "./.yarn/cache/github-markdown-css-npm-5.1.0-d2b2b6d421-e3472770de.zip/node_modules/github-markdown-css/",
          "packageDependencies": [
            ["github-markdown-css", "npm:5.1.0"]
          ],
          "linkType": "HARD",
